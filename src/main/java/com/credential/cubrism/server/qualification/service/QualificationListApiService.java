...
@Service
public class QualificationListApiService {
    @Value("${open.api.key:}")
    ...
    @Autowired
    public QualificationListApiService(QualificationListRepository qualificationListRepository, WebClient webClient) {
